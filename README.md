...
For each design pattern i have seperate folder which contains 3 main files: Implementation of design pattern, html template of design pattern, and .scss file with styles.
